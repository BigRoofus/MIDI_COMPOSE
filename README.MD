...
The Advanced Grid is a powerful visual tool for precise note placement. It can be configured to any time signature or meter, including standard, complex, odd, and mixed. Its tempo can be freely adjusted without affecting the original MIDI file's structure or playback. The original MIDI file's grid / time signature remains visible and unchanged in the background. Though the user can switch the MIDI file's grad / timesignature to the currenlt used Advanced Grid, if they choose.
<br>
<br>
