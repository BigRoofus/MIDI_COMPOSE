...
# but this module will be used for generating fugues from 
# a selected series of notes, AKA, a motif.

# The user can drag across a single track of MIDI for any length,
# then use this function to generate a fugue from it.

# After generation, the resulting fugue should open up
# in a new tab as a new composition.

# Perhaps using some kind of visual tree GUI system would
